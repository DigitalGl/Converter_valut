...
// метод splice. Позволяет добовлять , удалять и заменять элементы
...
// Удаляем элемент и возврощает его в переменную 
let arrTwo = ["Ваня", "Иштван", "Оля"];
let removed = arrTwo.splice(1, 1);
console.log(removed);

// Заменяем элементы 
let arrTree = ["Ваня", "Иштван", "Оля"];
// Начиная с нулевой позиции (Ваня), заменяем один элемент
arrTree.splice(0, 1, "Коля");
console.log(arrTree);


// Добовляем элементы
let arrFour = ["Ваня", "Иштван", "Оля"];
// Начиная с первой позиции (перед "Иштван"), добовляем два элемента
